...
for i in range(len(feconomics)):
    #print(fb['link'][i])
    sp.append([feconomics['link'][i], feconomics['text'][i], feconomics['title'][i], 1])

for i in range(len(ffinances)):
    #print(fb['link'][i])
    sp.append([ffinances['link'][i], ffinances['text'][i], ffinances['title'][i], 1])

for i in range(len(fpolitics)):
    #print(fb['link'][i])
    sp.append([fpolitics['link'][i], fpolitics['text'][i], fpolitics['title'][i], 3])
for i in range(len(ftrash)):
    #print(fb['link'][i])
    sp.append([ftrash['link'][i], ftrash['text'][i], ftrash['title'][i], 3])
